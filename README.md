...
> I want to read and parse some input, but it's a relatively **small** and **simple** parsing task, so I'd rather avoid adding a *heavy* crate like [nom](https://crates.io/crates/nom), [nom8](https://crates.io/crates/nom8) to my `dependencies`...
