...
> I want to read and parse some input, but it's **not so extensive** parsing task, so I'd like to avoid adding heavyweight libraries like [nom](https://crates.io/crates/nom) or [nom8](https://crates.io/crates/nom8) to my `dependencies` ...
